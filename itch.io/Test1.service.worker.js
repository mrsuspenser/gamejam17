...
/** @type {string} */
const CACHE_VERSION = '1752851932|1309446053';
/** @type {string} */
const CACHE_PREFIX = 'Game Jam 17-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["Test1.html","Test1.js","Test1.offline.html","Test1.audio.worklet.js","Test1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Test1.wasm","Test1.pck"];
